...
/**
 * Play a fish catch sound based on rarity
...
/**
 * Start ambient sound based on weather and time of day
...
export function startAmbientSound(weather, timeOfDay) {
  ...
  switch (weather) {
    ...
    case 'stormy':
      ...
      // Schedule occasional thunder sounds
      scheduleWeatherEffect('thunder', { volume: ambientVolume * 0.8 }, 20000, 60000);
      break;
    case 'sunny':
      if (isDaytime) {
        weatherSounds.push(
  ...
  // Always add some waves for fishing ambience
  weatherSounds.push(
    playSound('waves', { loop: true, volume: ambientVolume * 0.3 })
  );
}
